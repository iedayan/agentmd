  ...
  return (
    <div className="p-8 max-w-2xl bg-background min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Docker, Kubernetes, air-gapped support</p>
      </div>
      <div className="space-y-6">
        <Card>
          <CardHeader>
            <CardTitle>Docker Compose</CardTitle>
            <CardDescription>Single-command deploy with PostgreSQL + Redis</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Scale with Helm charts</CardDescription>
          </CardHeader>
          <CardContent>
            <pre className="rounded bg-muted p-4 text-sm overflow-x-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Set AGENTMD_LICENSE_KEY for Enterprise activation</CardDescription>
          </CardHeader>
          <CardContent>
