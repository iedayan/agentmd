...
import { DashboardStats, ActivityFeed, QuickActions } from "@/components/dashboard/dashboard-widgets";
import { PerformanceChart, ExecutionTrend, RepositoryHealth } from "@/components/dashboard/data-visualization";
