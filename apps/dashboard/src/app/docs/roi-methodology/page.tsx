...
export default function RoiMethodologyPage() {
  return (
    <div>
      ...
      <p className="lead">
        How we derive value from automation and failure prevention. Use this to interpret and
      ...
      <table className="w-full text-sm border-collapse">
        ...
        <tbody>
          ...
          <tr className="border-b">
            <td className="py-2">
              <code>platformCostMonthlyUsd</code>
            </td>
      ...
      <p>
        Each execution saves ~8 minutes of manual run/triage time. Gross labor value = hours saved ×
        hourly rate.
      </p>

      <h3>Failure prevention value</h3>
      <p>
        If your observed failure rate is lower than the baseline, the difference represents failures
        prevented by AgentMD. Value = prevented failures × incident cost.
      </p>

      <h3>Gross and net value</h3>
      <p>
        Gross value = labor value + failure value. Net value = gross value − platform cost. ROI
        multiple = gross / platform cost.
      </p>

      <h2>Confidence</h2>
      <ul>
        <li>
          <strong>Low</strong> — &lt; 80 executions in window
        </li>
        <li>
          <strong>Medium</strong> — 80–299 executions
        </li>
        <li>
          <strong>High</strong> — ≥ 300 executions
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Failure prevention depends on a realistic baseline. Use 15–25% if you don&apos;t have
          historical data.
        </li>
        <li>
      ...
      <p>
        Response includes <code>assumptions</code>, <code>metrics</code>, <code>value</code>, and{' '}
