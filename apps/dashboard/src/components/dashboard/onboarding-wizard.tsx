...
const STEPS = [
  {
    id: 'template',
    title: 'Get AGENTS.md',
    desc: 'Use the setup wizard to create your first AGENTS.md',
    href: '/dashboard/setup/agent',
  },
  {
    id: 'connect',
    title: 'Connect a repo',
    desc: 'Add your repository to start monitoring AGENTS.md',
    href: '/docs/quickstart',
  },
  {
    id: 'validate',
    title: 'Validate',
    desc: 'AgentMD parses and scores your AGENTS.md on every push',
    href: '/docs/parse',
  },
  {
    id: 'execute',
    title: 'Run execution',
    desc: 'Trigger a run or connect GitHub for automatic runs',
    href: '/docs/execution',
  },
];
...
export function OnboardingWizard() {
  ...
  const loadProgress = useCallback(async () => {
    ...
    try {
      ...
      const execsData = (await execsRes.json()) as {
        executions?: unknown[];
        meta?: { total?: number };
      };
        ...
        <Card className="relative overflow-hidden border-primary/30 bg-primary/[0.02] glass-card border-luminescent shadow-glow/5">
          {isScanning && (
            ...
            >
              ...
              <p className="mt-4 text-xs font-black uppercase tracking-[0.3em] text-primary animate-pulse">
                Scanning Repositories...
              </p>
              <p className="mt-1 text-[10px] text-muted-foreground font-medium italic">
                Found agents in /docs and root...
              </p>
            </motion.div>
          )}
                  ...
                  <motion.div
                    ...
                    className={cn(
                      'relative p-4 rounded-2xl border transition-all duration-500',
                        ...
                        : current
                          ? 'bg-background border-primary shadow-glow/10'
