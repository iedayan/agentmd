                ...
                <CardHeader className="p-8 pb-4">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            ...
                            <CardDescription className="text-[10px] font-black uppercase tracking-widest opacity-60">Share your agent-readiness</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                ...
                <CardContent className="p-8 pt-0 space-y-6">
                    <div className="space-y-4">
                        <p className="text-sm font-medium text-muted-foreground">
                            Add the live AgentMD badge to <span className="text-foreground font-bold">{repoName}</span>&apos;s README to signal reliability to partners and agents.
                        </p>
