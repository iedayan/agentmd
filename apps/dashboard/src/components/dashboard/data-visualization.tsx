  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>Pipeline success rate over the last 7 days</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            {data.labels.map((label, index) => (
              <div key={label} className="flex items-center gap-3">
                ...
                <div className="flex-1 relative">
                  <Progress value={data.values[index]} className="h-2" />
...
export function ExecutionTrend({ className }: ExecutionTrendProps) {
  ...
  const changePercent = (
    ((trendData.current - trendData.previous) / trendData.previous) *
    100
  ).toFixed(1);
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>24-hour pipeline execution volume</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
  ...
  return (
    <Card className={className}>
      <CardHeader>
        ...
        <CardDescription>Overall AGENTS.md compliance scores</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
              ...
              {healthData.map((repo, index) => {
                ...
                return (
                  <circle
                    ...
                    r="56"
                    stroke={
                      repo.health >= 90 ? '#10b981' : repo.health >= 75 ? '#f59e0b' : '#ef4444'
                    }
                    strokeWidth="12"
                    fill="none"
