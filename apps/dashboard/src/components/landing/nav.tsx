        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <Link href="/dashboard">
            <Button
              variant="ghost"
              size="sm"
              className="font-medium text-sm rounded-[var(--radius-sm)]"
            >
              Dashboard
            </Button>
          </Link>
          <Link href="/register">
            <Button
              size="sm"
              className="font-semibold text-sm rounded-[var(--radius-sm)] shadow-sm shadow-primary/20 ml-1"
            >
              Get Started
            </Button>
          </Link>
          ...
          <ul className="space-y-1">
            ...
            <li className="pt-3 mt-3 border-t border-border/50 flex gap-2">
              <Link href="/dashboard" onClick={() => setOpen(false)} className="flex-1">
                <Button variant="outline" className="w-full text-sm rounded-[var(--radius-sm)]">
                  Dashboard
                </Button>
              </Link>
