    ...
    criteria: [
      {
        ...
        suggestions: ["Add unit tests for new functionality", "Update existing tests to cover changed code"]
      },
      {
        name: "Build Success",
        score: 95,
              ...
              {mockResults.map((result) => (
                <div
                  ...
                  className={`p-3 rounded-lg border cursor-pointer transition-colors hover:bg-muted/50 ${
                    selectedResult?.id === result.id ? "border-primary bg-primary/5" : "border-border"
                  }`}
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      <CardTitle className="flex items-center gap-2">
                        ...
                        #{selectedResult.prNumber} {selectedResult.title}
                      </CardTitle>
                      <CardDescription>
                        {selectedResult.repo} • by {selectedResult.author} • Reviewed {new Date(selectedResult.reviewedAt).toLocaleString()}
                      </CardDescription>
                    </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-2xl font-bold ${getScoreColor(selectedResult.overallScore)}`}>
                    ...
                    <div className="flex items-center justify-between text-sm text-muted-foreground">
                      ...
                      <span>{selectedResult.criteria.filter(c => c.passed).length}/{selectedResult.criteria.length} checks passed</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
