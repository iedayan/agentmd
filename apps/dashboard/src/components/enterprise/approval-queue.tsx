...
import { ShieldCheck, CheckCircle2, Activity, AlertCircle, ArrowRight } from 'lucide-react';
          ...
          <CardHeader className="p-6 border-b border-border/5 bg-muted/5 group-hover:bg-indigo-500/[0.02] transition-all">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-sm font-black text-foreground/90 tracking-tight uppercase">
