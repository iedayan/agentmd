      ...
      <div className="glass-card bg-gradient-to-br from-primary/10 via-background to-background p-1 border-beam relative overflow-hidden group">
        ...
        <CardHeader className="relative z-10 p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <Badge
              variant="outline"
              className="text-[10px] font-black tracking-widest uppercase border-primary/30 text-primary"
            >
              Active Subscription
            </Badge>
          </div>
          ...
          <CardDescription className="text-base font-medium text-muted-foreground mt-2 max-w-2xl leading-relaxed">
            Your high-security infrastructure for governed agentic operations. $249/month — SOC2
            certified, air-gapped ready, 99.9% uptime SLA.
          </CardDescription>
        </CardHeader>
        <CardContent className="px-8 pb-8 relative z-10">
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <div
                key={item.label}
                className="flex items-center gap-2 px-4 py-2 rounded-2xl bg-primary/5 border border-primary/10 text-[11px] font-bold text-primary/80"
              >
              ...
              <CardHeader className="p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  {f.status === 'locked' ? (
                    <Badge
                      variant="secondary"
                      className="text-[9px] font-black tracking-widest uppercase opacity-60"
                    >
                      Locked
                    </Badge>
                  ) : (
                    <Badge
                      variant="outline"
                      className="text-[9px] font-black tracking-widest uppercase border-emerald-500/30 text-emerald-500 bg-emerald-500/5 animate-glow-pulse"
                    >
                      Active
                    </Badge>
                  )}
