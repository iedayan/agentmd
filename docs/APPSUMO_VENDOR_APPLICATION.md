# AgentMD — AppSumo Vendor Application
...
AgentMD is a **CI/CD platform for AI agents** that makes the [AGENTS.md](https://agents.md) standard executable. Developers write workflows in a single markdown file; AgentMD parses, validates, scores, and runs them—with built-in governance, approval workflows, and audit trails.

### One-Line Pitch

> **Make your repository agent-ready. Define workflows in AGENTS.md. AgentMD executes them with governance built in.**

### Target Customer

- **Primary:** Solo developers, indie hackers, and small dev teams (1–10 people) building with AI agents
- **Secondary:** Startups and SMBs adopting agentic AI who need governance before scaling
- **Use case:** Teams using Claude, Cursor, Copilot, or custom agents who want deterministic, auditable execution
...
## 3. Key Features (Included in All Tiers)
...
- **GitHub integration** — Actions, webhooks, status checks
- **Governance** — shell allowlists, approval workflows, policy rules
- **Audit logs** — who ran what, when, and why
- **Dashboard** — execution history, analytics, team management
...
- All tiers include: parallel execution, Slack/Discord notifications, priority support
- No Enterprise features (SSO, RBAC, self-hosted) — those remain on annual plans

---

## 5. Why AppSumo?

- **Early validation** — AgentMD is pre-product-market-fit; AppSumo helps us learn what matters
- **Target audience fit** — 800K+ entrepreneurs and small teams are exactly who we serve
- **Risk-free for users** — 60-day guarantee lowers barrier; we're confident in the product
- **No upfront cost** — Revenue share aligns incentives; we only pay when we earn
...
## 8. Launch Checklist (Before Submitting)

- [ ] 10–20 organic users with testimonials
- [ ] All known bugs fixed; production-ready
- [ ] Support process documented (tickets, SLA)
- [ ] AppSumo coupon/landing page live
- [ ] FAQ updated for lifetime deal terms
...
## 10. AppSumo Form Answers (Copy-Paste Ready)
...
- GitHub integration (Actions, webhooks, status checks)
- Governance (shell allowlists, approval workflows, policy rules)
- Audit logs (who ran what, when, why)
- Dashboard (execution history, analytics, team management)
- Badge API (live score badges for READMEs)
...
- **AI directories:** [List if submitted, e.g. AI Valley, There's An AI For That]

---

### Is your product self-serve? If so, what is the entry price point?

**Yes, fully self-serve.**

- **Entry price:** $0 (Free tier — 3 repos, 100 exec min/month, 7-day retention)
- **First paid tier:** $49/mo (Pro) or $69 one-time (AppSumo Tier 1)
- No sales call required for Free or Pro.
...
### Do you have any questions about AppSumo that you want to learn more about on a call?

1. **License redemption flow** — How do AppSumo buyers typically redeem? Do we integrate with AppSumo's API, or do we receive a list and manually activate?
2. **Refund handling** — What's the typical refund rate for developer tools, and how does AppSumo handle partial refunds (e.g., Tier 2 buyer downgrades to Tier 1)?
3. **Support expectations** — What's the expected response-time SLA for AppSumo buyers during and after the campaign?
4. **Upsell rules** — Can we offer AppSumo buyers a path to Enterprise (annual) for SSO/RBAC, or is that discouraged?
5. **Deal structure** — Any guidance on Tier 1–3 pricing for developer tools in the $50–300 range?
