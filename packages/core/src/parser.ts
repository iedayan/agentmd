 ...
 */
function parseSections(lines: string[]): AgentsMdSection[] {
...
function parseSectionsTree(lines: string[]): AgentsMdSection[] {
 ...
 */
export function findSection(parsed: ParsedAgentsMd, title: string): AgentsMdSection | undefined {
