 ...
 */
export async function checkCommandIntent(command, context) {
...
function detectSensitiveAccess(cmd) {
...
function detectDestructiveIntent(cmd) {
 ...
 */
function detectPathTraversal(cmd) {
 ...
 */
function detectEnvVarInjection(cmd) {
 ...
 */
function detectSystemModification(cmd) {
  const systemPaths = [
    '/etc/',
    '/usr/bin/',
    '/usr/sbin/',
 ...
 */
function detectCryptoMining(cmd) {
